...
// member function on the duration object  
   ...
   cudaDeviceSynchronize();
    ...
    //commented out the functions which helps to calculate time
    printf("Time to do host to device memory transfer= %f ms\n", et);
     printf("Total time to execute kernel= %f ms\n", et1);
      printf("Time to do device to host  memory transfer= %f ms\n", et2);
     



	printf("Average kernel time per iteration= %f ms\n",et1/50);
